...
hoistedDependencies:
  ...
  /@httptoolkit/httpolyglot/2.1.0:
    '@httptoolkit/httpolyglot': private
  /@httptoolkit/proxy-agent/5.0.1-socks-lookup-fix.0:
    '@httptoolkit/proxy-agent': private
  /@httptoolkit/socks-proxy-agent/6.1.1-use-request-lookup-fix.0:
    '@httptoolkit/socks-proxy-agent': private
  /@httptoolkit/subscriptions-transport-ws/0.9.19_graphql@15.8.0:
    '@httptoolkit/subscriptions-transport-ws': private
  /@httptoolkit/websocket-stream/6.0.1:
    '@httptoolkit/websocket-stream': private
  ...
  /@size-limit/esbuild/8.1.1_size-limit@8.1.1:
    '@size-limit/esbuild': private
  /@size-limit/file/8.1.1_size-limit@8.1.1:
    '@size-limit/file': private
  ...
  /@typescript-eslint/experimental-utils/5.48.1_iukboom6ndih5an6iafl45j2fe:
  ...
  /eslint-plugin-import/2.27.0_qdjeohovcytra7xto5vgmxssaq:
    eslint-plugin-import: public
  /eslint-plugin-jest/25.7.0_ohsifnwenhmxgcp7mend4dnv74:
...
pendingBuilds: []
prunedAt: Thu, 12 Jan 2023 02:06:53 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /esbuild-windows-64/0.15.18
  - /esbuild-windows-arm64/0.15.18
storeDir: /Users/puni/Library/pnpm/store/v3
