...
export declare class JsonRpcProvider extends Provider {
    ...
    devInspectTransaction(txBytes: string): Promise<DevInspectResults>;
    devInspectMoveCall(sender: SuiAddress, moveCall: RawMoveCall): Promise<DevInspectResults>;
