...
export declare class VoidProvider extends Provider {
    ...
    devInspectMoveCall(_sender: SuiAddress, _moveCall: RawMoveCall): Promise<DevInspectResults>;
