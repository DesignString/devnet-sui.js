...
export declare abstract class Provider {
     ...
     * budget
     */
    abstract devInspectMoveCall(sender: SuiAddress, moveCall: RawMoveCall): Promise<DevInspectResults>;
    /**
